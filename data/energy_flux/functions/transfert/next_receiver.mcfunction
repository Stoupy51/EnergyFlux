...
execute as @e[type=#energy_flux:devices,tag=EF_CanReceive,tag=EF_Use] if score @s EF_MachineID = MachineID EF_Temp run function energy_flux:transfert/receive
