...
execute unless score GameVersion load.status matches 10 if score GameVersion load.status matches 2860.. run tellraw @a {"text":"[Loaded Energy Flux v1.3.0]","italic":false,"color":"green"}
