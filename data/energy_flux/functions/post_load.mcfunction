...
execute unless score GameVersion EF_Versions matches 10 if score GameVersion EF_Versions matches 2724.. run tellraw @a {"text":"[Loaded Energy Flux API v1.1.4]","italic":false,"color":"green"}
