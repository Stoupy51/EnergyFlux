...
execute unless score GameVersion EF_Versions matches 10 if score GameVersion EF_Versions matches 2724.. run tellraw @a {"text":"[Loaded Energy Flux v1.2.0]","italic":false,"color":"green"}
