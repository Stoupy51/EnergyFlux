...
scoreboard players set Version EF_Data 1010
...
execute unless score GameVersion EF_Data matches 10 if score GameVersion EF_Data matches 2724.. run tellraw @a {"text":"[Loaded Energy Flux API v1.1.0]","color":"green"}
